...
const Hero = ({ scrollToSection }) => {
  return (
    <section
      id="home"
      className="min-h-screen pt-20 flex items-center bg-gray-900"
    >
          ...
          <div className="md:w-1/2 mb-12 md:mb-0">
            <div className="text-white">
              <h1 className="text-5xl md:text-7xl font-bold mb-6">
                Hola, soy{" "}
                <span className="block gradient-text">Federico Britez</span>
              </h1>
              <p className="text-xl md:text-2xl mb-8 text-gray-300">
                Desarrollador JR con solidos conocimientos en React, React
                Native, SAP y tecnologías modernas
              </p>
